...
export const ETH = WETH9[chainId]
export const DAI = new Token(ChainId.MAINNET, "0x6B175474E89094C44Da98b954EedeAC495271d0F", 18);
export const WETH = new Token(ChainId.MAINNET, "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", 18);
export const USDC = new Token(ChainId.MAINNET, "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", 6)
export const ARS = new Token(ChainId.MAINNET, "0x042844589E4735cf8dEc1f48Cd4dEF37871c612e", 18)
